    ...
    return (
        <div className='py-5 px-5 md:px-12 lg:px-28 '>
            <div className='flex justify-between items-center '>
                ...
                <button className='flex items-center gap-2 font-medium py-1 px-3 sm:py-3 sm:px-6 text-white cursor-pointer bg-pink-400 hover:shadow-[0px_0px_15px_#000000]'>Get Started <Image src={assets.arrow} alt=''/> </button>
            </div>
        ...
        <form onSubmit={onSubmitHandler} className='flex justify-between max-w-[500px] scale-75 sm:scale-100 mx-auto mt-10 border border-black '>
            ...
            <button type='submit' className='border-l border-black py-1 px-4 sm:py-4 sm:px-8 cursor-pointer text-white bg-pink-400 active:bg-fuchsia-800 active:text-white'>Subscribe</button>
